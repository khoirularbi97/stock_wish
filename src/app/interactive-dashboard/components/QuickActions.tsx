  ...
  const actions: Action[] = [
    {
      id: 1,
      title: 'Analyze Stock',
      description: 'Run AHP-SAW analysis on individual stocks',
    ...
    },
    {
      ...
      description: 'Side-by-side comparison with custom criteria',
      icon: 'TableCellsIcon',
    ...
    },
    {
      id: 3,
      title: 'View Results',
      description: 'Explore analysis results and rankings',
      icon: 'ChartPieIcon',
    ...
    },
    {
      id: 4,
      title: 'My Workspace',
      description: 'Access saved analyses and portfolios',
      icon: 'FolderIcon',
      href: '/user-workspace',
  ...
  return (
    <div className={`bg-card border border-border rounded-lg p-8 md:p-6 sm:p-4 ${className}`}>
      <div className="flex items-center justify-between mb-6 md:mb-4 sm:mb-3">
        <h2 className="text-xl md:text-lg sm:text-base font-semibold text-text-primary">Quick Actions</h2>
