  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        brand: {
          primary: 'var(--color-brand-primary)', /* sea-green */
          secondary: 'var(--color-brand-secondary)', /* steel-blue */
          accent: 'var(--color-brand-accent)', /* coral-orange */
          trust: 'var(--color-brand-trust)', /* sage-gray */
          cta: 'var(--color-brand-cta)', /* emerald-green */
        },
        text: {
          primary: 'var(--color-text-primary)', /* dark-slate */
